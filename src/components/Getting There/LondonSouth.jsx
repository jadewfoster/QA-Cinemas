...
export default function LondonSouth() {
    ...
    return(
        <div>
            <h3 className="title">Directions to our London South cinema:</h3>
            <div align="center">
            <iframe width="600" height="500" id="gmap_canvas" title="londonsouth"
        ...
        <h5 className="smallsubtitle">By Overground</h5>
