...
import "./places.css";
import pic from './cafe_tpt-central.avif'
import pic1 from './ducksoup-central.avif'
import pic2 from './chishuru-south.avif'
import pic3 from './persepolis-south.24.avif'
import pic4 from './mangal ii - north.avif'
import pic5 from './tankatsu - north.49.avif'
      ...
      <Container>
        ...
        <div align="left">
          <div>
            ...
            <p style={{float:"right"}}>Perfect for a casual weeknight dinner, catching up with mates or dining solo, 
            ...
            <p style={{float:"right"}}>Perfect for a catch-up with mates or just drink and some light bites. If you like modern European food, and want to go for a classy and casual option around central London Ducksoup is an ever reliable lunch or dinner hangout.</p>
            ...
            <div>
            <p style={{float:"right"}}  > Vegetarian friendly, West African cuisine from Chishuru is a guaranteed part of the evening, ekuru, goat ayamase and plantain and baobab ice cream are our favourite dishes!</p>
            ...
            <p style={{float:"right"}}>Persian inspired vegetarian and vegan cuisine, perfect for a cheap, healthy lunch. There's meze, falafels, and a gorgeous black honey ice cream sundae as well loads of unexpected bits in between!</p>
            ...
            <p style={{float:"right"}}>How could you go wrong with Turkish food? Mushroom manti to die for, as well as bits and bobs on the restaurant menu that change regularly. But don't worry, if you are not too adventurous, you can always find a reliable kofte and a doner.</p>
            ...
            <h2>Tankatsu</h2>
            <img src={pic5} alt="img"></img>
            <p style={{float:"right"}}>Tanakatsu is best known for it's katsu dishes. The modern Japanese diner is ten minutes away from our cinemas. The sushi is a favourite of ours, and ofcourse at £12-£15 it is a reliably tasty fare.</p>
